        ...
        try:
            ...
            if st.button("Train Model"):
                with st.spinner("Training model..."):
                    ...
                    model_bytes.seek(0)
                    st.download_button("📥 Download Trained Model", data=model_bytes, file_name="model.pkl")
...
tab1, tab2, tab3, tab4 = st.tabs(["AutoML", "Explainability", "Visualization", "Data Cleaning"])
